...
✅ Register (if needed) and Sign In to Astra [https://astra.datastax.com](https://dtsx.io/astra-6-3): You can use your `Github`, `Google` accounts or register with an `email`.
