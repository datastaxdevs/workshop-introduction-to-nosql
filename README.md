...
✅ Register (if needed) and Sign In to Astra [https://astra.datastax.com](http://astra.new/intro-nosql): You can use your `Github`, `Google` accounts or register with an `email`.
