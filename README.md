...
✅ Register (if needed) and Sign In to Astra DB [https://astra.datastax.com](https://dtsx.io/astraDB-617): You can use your `Github`, `Google` accounts or register with an `email`.
